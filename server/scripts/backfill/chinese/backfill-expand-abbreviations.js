...
const { stampEntries, validatedClause } = initRunLog({ script: 'chinese/backfill-expand-abbreviations', version: SCRIPT_VERSION });
...
async function backfillExpandAbbreviations() {
  ...
  try {
    ...
    const result = await client.query(`
      ...
      WHERE language = 'zh'
        AND ${validatedClause(['definitions'], 'dictionaryentries_zh')}
      ORDER BY id
    `);
