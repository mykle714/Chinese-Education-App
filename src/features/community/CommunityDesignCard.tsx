...
const CommunityDesignCard: React.FC<{
...
}> = ({ design, voted, voteDeltas, language, onVoteChange, onOpen }) => {
  ...
  return (
    ...
    >
      ...
      <VoteButton design={design} voted={voted} voteDeltas={voteDeltas} language={language} onVoteChange={onVoteChange} size="small" />
    </Box>
  );
};
