 ...
 *   - src/pages/FlashcardsLearnPage/cardIconLayout.ts  (source of truth)
...
import { DEFAULT_PLACEMENT_SCALES as CLIENT_SCALES, DEFAULT_ICON_SCALE } from '../pages/FlashcardsLearnPage/cardIconLayout';
