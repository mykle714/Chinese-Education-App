...
/**
 * Community page (docs/COMMUNITY_PAGE.md) — a Home-hub drill-in (NodePage) with two
 * horizontally-scrolling, infinitely-paginated feeds of other users' advanced card-icon layouts:
 ...
 * Both share the zoom/vote/apply flow. `votedKeys` is loaded once and lifted here so a vote in
 * either feed greys the design in both.
 */
