...
const { stampEntries, accrueUsage, staleClause } = initRunLog({ script: 'chinese/backfill-classifier', version: SCRIPT_VERSION, anthropic });
...
const doneGate = isStale ? `(classifier IS NULL OR ${staleClause()})` : 'classifier IS NULL';
