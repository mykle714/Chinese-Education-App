/**
 * Backfill Script: AI-powered English word forms for dictionaryentries
 *
    ...
    for (const row of entries) {
      ...
      try {
        ...
        if (!wordForms) {
          ...
          await client.query(
            `UPDATE dictionaryentries SET "wordForms" = '{}'::jsonb WHERE id = $1`,
            [row.id]
          );
        ...
        await client.query(
          `UPDATE dictionaryentries SET "wordForms" = $1::jsonb WHERE id = $2`,
