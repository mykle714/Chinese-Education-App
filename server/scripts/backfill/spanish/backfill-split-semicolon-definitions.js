/**
 * Backfill Script: Split semicolon-delimited definitions for dictionaryentries_es (SPANISH)
 *
 * Spanish counterpart of backfill/chinese/backfill-split-semicolon-definitions.js.
 * Deterministic string op (no AI) — operates on every es row's `definitions`
 * array. Definitions are English glosses, so the logic is identical to the
